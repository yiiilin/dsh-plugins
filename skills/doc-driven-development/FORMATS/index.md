...
- Source files name their doc: `// doc: docs/<name>.md`
...
| [import.md](import.md) | design | awaiting confirmation | v1 | `src/import/**` | architecture.md | D2, ⚠D5 |
| `docs/adr/` (4) | decisions | — | — | — | — | — |

## Open decision points

- [ ] `import.md` D2 — eviction policy; recommend in-process LRU
- [ ] ⚠ `import.md` D5 — drop the legacy `mode` column; needs an explicit answer
