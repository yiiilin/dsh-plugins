...
runCLI(() => {
  ...
  const required = ['scripts/receipt-view.mjs', 'tests/reduction.mjs', 'VERIFICATION.md', 'EVALUATION.md', 'FORMATS/verification-plan.md', 'scripts/verification.mjs', 'scripts/verify.mjs', 'scripts/run-process.mjs', 'scripts/test-results.mjs', 'scripts/node-reporter.mjs', 'scripts/eval.mjs', 'tests/verification.mjs', 'tests/evaluation.mjs', 'README.md', 'REFERENCE.md', 'ADOPTION.md', 'CHANGELOG.md', 'TESTING.md', 'LICENSE', 'THIRD-PARTY-NOTICES.md',
    'FORMATS/feature.md', 'FORMATS/architecture.md', 'FORMATS/module.md', 'FORMATS/change.md', 'FORMATS/adoption.md',
    'EXECUTION.md', 'COMMUNICATION.md', 'ORCHESTRATION.md', 'UPGRADE.md', 'ENGINEERING.md', 'FORMATS/delivery.md', 'scripts/upgrade.mjs', 'scripts/identity.mjs', 'scripts/delivery.mjs', 'tests/delivery.mjs', 'tests/upgrade.mjs', 'examples/execution-session.md', 'DESIGN.md', 'CONTEXT.md', 'scripts/contract.mjs', 'scripts/context.mjs', 'tests/closure.mjs', 'tests/context.mjs', 'examples/collaboration-session.md', 'examples/evaluation.md', 'examples/import-design.md', 'scripts/design-check.mjs', 'tests/design.mjs', 'INSTALL.md', 'LAYOUT.md', 'scripts/doc-layout.mjs', 'tests/layout.mjs', 'package-manifest.json', 'scripts/install.mjs', 'scripts/uninstall.mjs', 'scripts/doctor.mjs', 'scripts/project-install.mjs', 'scripts/managed-text.mjs', 'tests/install.mjs', 'tests/activation.mjs',
  ...
  if (!args.flags['no-tests']) {
    const result = spawnSync(process.execPath, ['--test', '--test-reporter=tap', path.join(root, 'tests/run.mjs'), path.join(root, 'tests/install.mjs'), path.join(root, 'tests/activation.mjs'), path.join(root, 'tests/layout.mjs'), path.join(root, 'tests/design.mjs'), path.join(root, 'tests/closure.mjs'), path.join(root, 'tests/context.mjs'), path.join(root, 'tests/delivery.mjs'), path.join(root, 'tests/upgrade.mjs'), path.join(root, 'tests/verification.mjs'), path.join(root, 'tests/evaluation.mjs'), path.join(root, 'tests/reduction.mjs')], {
